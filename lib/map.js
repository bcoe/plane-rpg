...
(function() {
  ...
  Map.prototype.createNPCs = function() {
    ...
    var sally = new foundima.NPC({
      ...
      pulled: 0,
      name: 'Sally',
      greetings: ["Hey, I'm Sally, welcome to Four Barrel", "What can I do you for?", "Want to make some money? pull some espresso for us?"],
      actions: {
        pull: function(_this, value) {
          _this.pulled += 1;
          _this.console.message("You've pulled " + _this.pulled + ' espressos.');
          _this.player.money += 1;
          _this.console.message("You've received $1 for pulling espressos. You now have $" + _this.player.money);
        }
      }
    });
